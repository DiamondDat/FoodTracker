...
//  FoodTracker
//
//  Created by Tang Tuong Dat on 9/11/17.
//  Copyright © 2017 DiamondDat. All rights reserved.
//
...
class MealViewController: UIViewController, UITextFieldDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    //MARK: IUImagePickerControllerDelegate
    ...
    @IBAction func selectImageFromPhotoLibrary(_ sender: UITapGestureRecognizer) {
        ...
        // UIImagePickerController is a view controller that lets a user pick media fromt their photo library
